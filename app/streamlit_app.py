...
rf_model_file = models_path / "best_model.pkl"
gb_model_file = models_path / "gb_model.pkl"  # jeśli chcesz mieć GB też lokalnie

rf_model = joblib.load(rf_model_file)
# Jeśli masz GradientBoosting, wczytaj analogicznie:
...
st.write(f"Random Forest (tuned) Accuracy: {acc:.4f}")
